...
def get_args():
    ...
    parser.add_argument('--batch_size', type=int,
                        default=16, help='batch_size')  #default=32
    ...
    parser.add_argument('--data_file', type=str, default='./pic_fft_mtf/',
                        help='root_dir')
    parser.add_argument('--dataset', type=str, default='pic_fft_mtf')
    ...
    parser.add_argument('--max_epoch', type=int,
                        default=3, help="max iterations")  #default=120
...
if __name__ == '__main__':
    ...
    print(algorithm._modules.items())
    algorithm.train()
    ...
    print(acc_record['train'])
    print(acc_record['valid'])
    print(acc_record['target'])
    plt.plot(acc_record['train'], label='Train Accuracy')
    plt.plot(acc_record['valid'], label='Valid Accuracy')
    plt.plot(acc_record['target'], label='Target Accuracy')
    plt.title('Training&Validation& Target Accuracy')
    plt.legend()
    plt.show()
