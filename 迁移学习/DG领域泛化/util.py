...
def img_param_init(args):
    ...
    if dataset == 'office':
        ...
        domain = ['amazon', 'dslr', 'webcam', 'caltech']
    elif dataset == 'office-home':
        domain = ['Art', 'Clipart', 'Product', 'Real_World']
    elif dataset == 'dg5':
        domain = ['mnist', 'mnist_m', 'svhn', 'syn', 'usps']
    elif dataset == 'PACS':
        domain = ['art_painting', 'cartoon', 'photo', 'sketch']
    elif dataset == 'VLCS':
        domain = ['Caltech101', 'LabelMe', 'SUN09', 'VOC2007']
    elif dataset == 'pic_fft_mtf':
        domain = ['0HP', '1HP', '2HP', '3HP']
    elif dataset == 'pic_fft_mtf_YJC':
        domain = ['0HP', '1HP', '2HP', '3HP']
    else:
    ...
    args.img_dataset = {
        ...
        'pic_fft_mtf': ['0HP', '1HP', '2HP', '3HP'],
        'pic_fft_mtf_YJC': ['0HP', '1HP', '2HP', '3HP']
    }
    if dataset == 'dg5':
        ...
        if args.dataset == 'office-home':
            ...
            args.num_classes = 5
        elif args.dataset == 'pic_fft_mtf':
            args.num_classes = 10
        elif args.dataset == 'pic_fft_mtf_YJC':
            args.num_classes = 10
    return args
